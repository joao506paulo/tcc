...
class _KnowledgeGraphWidgetState extends State<KnowledgeGraphWidget> {
  ...
  void initState() {
    ...
    // Cria uma instância de configuração (mesmo que vazia)
    // A configuração é obrigatória mas não tem as propriedades que você estava tentando definir
    var configuration = gv.FruchtermanReingoldConfiguration();
    
    // Inicializa o algoritmo passando a configuração
    _algorithm = gv.FruchtermanReingoldAlgorithm(configuration);
